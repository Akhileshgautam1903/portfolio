...
const Projects = () => {
  return (
    <div className="grid lg:grid-cols-3 gap-18">
      ...
      <ProjectCard head="Zen Diary" sub="MERN STACK" imgSrc={web2} className="lg:col-span-2 bg-pink-400" wide={true} link="https://zen-diary.onrender.com/"/>
      <ProjectCard head="Explore Earth" sub="HTML/CSS BOOTSTRAP" imgSrc={web3} className="lg:col-span-2 bg-red-400" wide={true} link="https://akhileshgautam1903.github.io/Exploreearth/"/>
